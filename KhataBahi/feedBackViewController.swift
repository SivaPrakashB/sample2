...
class feedBackViewController: UIViewController,UITextFieldDelegate,XMLParserDelegate {
    ...
    func submitFeedBack()
    {var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><SubmitFeedbacks xmlns=\"http://tempuri.org/\"><Name>\(companyNameText1)</Name><email>\(emailID.text!)</email><mono>\(mobileNUmber.text!)</mono><msg>\(feedBack.text!)</msg><SecurityKey>#111000$</SecurityKey></SubmitFeedbacks></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/SubmitFeedbacks", forHTTPHeaderField: "SOAPAction")
...
"""
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        ...
        if elementName == "SubmitFeedbacksResult" {
