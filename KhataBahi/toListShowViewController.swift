...
//  toListShowViewController.swift
//  KhataBahi
...
class toListShowViewController: UIViewController,XMLParserDelegate,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate {
    var selection=0
...
paymentCondition=UserDefaults.standard.object(forKey: "CashPaymentCondition") as! Int
    ...
    func GetLedgersCASH()
    {selection=0
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetLedgersOTHER xmlns=\"http://tempuri.org/\"><CompanyName>\(dashBoardCompanyName)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></GetLedgersOTHER></soap:Body></soap:Envelope>"
