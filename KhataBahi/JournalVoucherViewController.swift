//
//  JournalVoucherViewController.swift
//  KhataBahi
//
...
class JournalVoucherViewController:UIViewController,UITextFieldDelegate,XMLParserDelegate,UIGestureRecognizerDelegate,UITableViewDelegate,UITableViewDataSource {
