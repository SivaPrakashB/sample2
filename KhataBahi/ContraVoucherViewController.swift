//
//  ContraVoucherViewController.swift
//  KhataBahi
//
...
class ContraVoucherViewController: UIViewController,UITextFieldDelegate,XMLParserDelegate,UIGestureRecognizerDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        if textField==by
        { UserDefaults.standard.set(6, forKey: "CashPaymentCondition")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        posNameLabel.text="Contra Voucher(\(posName))"
    ...
    {
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetVoucherNo xmlns=\"http://tempuri.org/\"><MethodName>ContraVoucherEntry</MethodName><pos>\(posSRNO)</pos><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></GetVoucherNo></soap:Body></soap:Envelope>"
    ...
    func submitCashPayment()
    {
        ...
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><SubmitCV_Voucher xmlns=\"http://tempuri.org/\"><VoucherNo>\(GetVoucherNoResult)</VoucherNo><from_lgr>\(ByID)</from_lgr><to_lgr>\(ToID)</to_lgr><tra_dte>\(result1)</tra_dte><Total>\(enterAmmount.text!)</Total><remark>\(narration1.text!)</remark><pos>\(posSRNO)</pos><BilByBillDetails>No</BilByBillDetails><PaymentMode>\(paymentMode.text!)</PaymentMode><Ref_no>\(paymentReferenceNUmber)</Ref_no><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><user_id>\(loginUsername123)</user_id><SecurityKey>KBRE@#4321</SecurityKey></SubmitCV_Voucher></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/SubmitCV_Voucher", forHTTPHeaderField: "SOAPAction")
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        ...
        if elementName == "SubmitCV_VoucherResult" {
            selection==1
