//
//  itemCompanyMasterViewController.swift
//  KhataBahi
//
...
class itemCompanyMasterViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,XMLParserDelegate {
...
"""
    ...
    func getItemList(){
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetItemCompanyList xmlns=\"http://tempuri.org/\"><CompanyName>\(companyNameText)</CompanyName><DB>\(db_name)</DB><SecurityKey>KBRE@#4321</SecurityKey></GetItemCompanyList></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("http://tempuri.org/GetItemCompanyList", forHTTPHeaderField: "SOAPAction")
    ...
    func upDateItemCompany(){
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><UpdateItemCompany xmlns=\"http://tempuri.org/\"><Sno>\(serialNo)</Sno><ItemCompany>\(createItemCompanyName.text!)</ItemCompany><CompanyName>\(companyNameText)</CompanyName><DB>\(db_name)</DB><SecurityKey>KBRE@#4321</SecurityKey></UpdateItemCompany></soap:Body></soap:Envelope>"
        let is_URL: String = serverUrl+"WSKhataBahiOnline.asmx"
        print(is_SoapMessage)
        let lobj_Request = NSMutableURLRequest(url: NSURL(string: is_URL)! as URL)
        let session = URLSession.shared
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/UpdateItemCompany", forHTTPHeaderField: "SOAPAction")
    ...
    func createItemCompany(){
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><CreateItemCompany xmlns=\"http://tempuri.org/\"><ItemCompany>\(createItemCompanyName.text!)</ItemCompany><CompanyName>\(companyNameText)</CompanyName><DB>\(db_name)</DB><SecurityKey>KBRE@#4321</SecurityKey></CreateItemCompany></soap:Body></soap:Envelope>"
        let is_URL: String = serverUrl+"WSKhataBahiOnline.asmx"
        print(is_SoapMessage)
        let lobj_Request = NSMutableURLRequest(url: NSURL(string: is_URL)! as URL)
        let session = URLSession.shared
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/CreateItemCompany", forHTTPHeaderField: "SOAPAction")
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        if elementName == "GetItemCompanyListResult"  {
            elementValue = String()
            selection=0
            
        }
        if elementName == "UpdateItemCompanyResult" {
            elementValue = String()
            selection=1
            
        }
        if elementName == "CreateItemCompanyResult" {
            elementValue = String()
            selection=2
