...
class purchaselistViewController: UIViewController,XMLParserDelegate,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate {
    ...
    @IBAction func getList(_ sender: UIButton) {
        ...
        let vc=st.instantiateViewController(withIdentifier: "purchaseListViewShow") as! UIViewController
