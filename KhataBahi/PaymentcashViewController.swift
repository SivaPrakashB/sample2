...
//  KhataBahi
//
//  Created by Narayan on 5/11/18.
//  Copyright © 2018 senovTech. All rights reserved.
//

import UIKit

class PaymentcashViewController: UIViewController,UITextFieldDelegate,XMLParserDelegate,UIGestureRecognizerDelegate {
 ...
 */
 ...
 if textField==by
 { UserDefaults.standard.set(0, forKey: "CashPaymentCondition")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        posNameLabel.text="Cash Payment (\(posName))"
        print("Cash Payment (\(posName))*********bvsp")
        getVoucherNumber()
    }
...
//narration1.resignFirstResponder()
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        {enterAmmount.textColor=UIColor.white
            ...
            scrollView1.setContentOffset(CGPoint(x: 0, y: 120), animated: true)
        }
    ...
    {
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetVoucherNo xmlns=\"http://tempuri.org/\"><MethodName>CashPaymentsVouchers</MethodName><pos>\(posSRNO)</pos><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></GetVoucherNo></soap:Body></soap:Envelope>"
    ...
    func submitCashPayment()
    {
        ...
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><SubmitCP_Voucher xmlns=\"http://tempuri.org/\"><VoucherNo>\(GetVoucherNoResult)</VoucherNo><from_lgr>\(ByID)</from_lgr><to_lgr>\(ToID)</to_lgr><tra_dte>\(result1)</tra_dte><Total>\(enterAmmount.text!)</Total><remark>\(narration1.text!)</remark><pos>\(posSRNO)</pos><BilByBillDetails>No</BilByBillDetails><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><user_id>\(loginUsername123)</user_id><SecurityKey>KBRE@#4321</SecurityKey></SubmitCP_Voucher></soap:Body></soap:Envelope>"
       ...
       // var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><SubmitCP_Voucher xmlns=\"http://tempuri.org/\"><VoucherNo>\(GetVoucherNoResult)</VoucherNo><from_lgr>string</from_lgr><to_lgr>string</to_lgr><tra_dte>string</tra_dte><Total>\(enterAmmount.text!)</Total><remark>ffjkj</remark><pos>\(posSRNO)</pos><BilByBillDetails></BilByBillDetails><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></SubmitCP_Voucher></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/SubmitCP_Voucher", forHTTPHeaderField: "SOAPAction")
    ...
    if elementName == "GetVoucherNoResult" {
        ...
        if elementName == "SubmitCP_VoucherResult" {
            selection==1
