//
//  CreateNewLedgerViewController.swift
//  KhataBahi
//
//  Created by Narayan on 5/17/18.
//  Copyright © 2018 senovTech. All rights reserved.
//

import UIKit

class CreateNewLedgerViewController: UIViewController,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,XMLParserDelegate,UIGestureRecognizerDelegate{
           ...
           DispatchQueue.main.async {
               if self.createGroupLedgerFinalResult != nil
               {
                ...
                else
                {
                    ...
                    UserDefaults.standard.set(self.ledgerNameText.text!, forKey: "byValue")
                    if self.creditAndDebitStatus=="Cr"
                    {
                    UserDefaults.standard.set(self.enterAmountStatus+"Cr", forKey: "byAmount")
                    }
                    else
                    {
                         UserDefaults.standard.set(self.enterAmountStatus+"Dr", forKey: "byAmount")
                    }
                    UserDefaults.standard.set(self.createGroupLedgerFinalResult, forKey: "ByID")
