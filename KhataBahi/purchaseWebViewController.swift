//
//  purchaseWebViewController.swift
//  KhataBahi
//
...
class purchaseWebViewController: UIViewController,UIWebViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        var url=serverurl+"Process/PurchaseInvoice?"+"PID=\(pid)&DB=\(db_name)&CompanyName=\(dashBoardCompanyName1)&FnYear=\(dashBoardElementValueForFn)" as! String
