//
//  multiplePOSNamesViewController.swift
//  KhataBahi
//
//  Created by Narayan on 5/14/18.
//  Copyright © 2018 senovTech. All rights reserved.
//

import UIKit

class multiplePOSNamesViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,XMLParserDelegate{
    ...
    override func viewDidLoad() {
        ...
        company_names=UserDefaults.standard.object(forKey: "posMultipleName") as! [String]
         posSRNos=UserDefaults.standard.object(forKey: "posMultipleSrno") as! [String]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UserDefaults.standard.set(company_names[indexPath.row], forKey: "posSingleName")
       
        UserDefaults.standard.set(posSRNos[indexPath.row], forKey: "posSingleSrno")
        tableView1.isHidden=true
    }
