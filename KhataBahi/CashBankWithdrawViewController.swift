//
//  CashBankWithdrawViewController.swift
//  KhataBahi
//
...
class CashBankWithdrawViewController: UIViewController,UITextFieldDelegate,XMLParserDelegate,UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var dummyLastYear = UserDefaults.standard.object(forKey: "dashBoardElementValueForFn") as! String
        ...
        /* 300718  let date = Date()
         ...
         datefield123.text="\(result) (\(first3))"300718*/
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        if textField==by
        { UserDefaults.standard.set(4, forKey: "CashPaymentCondition")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        posNameLabel.text="Cash Bank Withdraw (\(posName))"
    ...
    {let toolBar11=UIToolbar()
        ...
        // To set minimum and maximum dates
    ...
    {
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetVoucherNo xmlns=\"http://tempuri.org/\"><MethodName>CashBankWidrowVoucher</MethodName><pos>\(posSRNO)</pos><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></GetVoucherNo></soap:Body></soap:Envelope>"
    ...
    func submitCashPayment()
    {
        ...
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><SubmitBW_Voucher xmlns=\"http://tempuri.org/\"><VoucherNo>\(GetVoucherNoResult)</VoucherNo><from_lgr>\(ByID)</from_lgr><to_lgr>\(ToID)</to_lgr><tra_dte>\(self.result1)</tra_dte><Total>\(enterAmmount.text!)</Total><remark>\(narration1.text!)</remark><pos>\(posSRNO)</pos><BilByBillDetails>No</BilByBillDetails><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><user_id>\(loginUsername123)</user_id><SecurityKey>KBRE@#4321</SecurityKey></SubmitBW_Voucher></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("text/xml; charset=utf-8", forHTTPHeaderField: "Content-Type")
        lobj_Request.addValue(String(is_SoapMessage.characters.count), forHTTPHeaderField: "Content-Length")
        lobj_Request.addValue("http://tempuri.org/SubmitBW_Voucher", forHTTPHeaderField: "SOAPAction")
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        ...
        if elementName == "SubmitBW_VoucherResult" {
            selection==1
