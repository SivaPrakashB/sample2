//
//  purchaseListShowViewController.swift
//  KhataBahi
//
...
class purchaseListShowViewController: UIViewController,XMLParserDelegate,UITableViewDelegate,UITableViewDataSource {
    var db_name=String()
...
"""
    ...
    func listViewShow(){
        var is_SoapMessage: String = "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema/\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><GetPurchaseList xmlns=\"http://tempuri.org/\"><start>\(a)</start><end>\(b)</end><FromDte>\(startDate)</FromDte><ToDte>\(endDate)</ToDte><CName>\(cName)</CName><CompanyName>\(dashBoardCompanyName1)</CompanyName><DB>\(db_name)</DB><FnYear>\(dashBoardElementValueForFn)</FnYear><SecurityKey>KBRE@#4321</SecurityKey></GetPurchaseList></soap:Body></soap:Envelope>"
        ...
        lobj_Request.addValue("http://tempuri.org/GetPurchaseList", forHTTPHeaderField: "SOAPAction")
    ...
    func parser(_ parser: XMLParser, didStartElement elementName: String, namespaceURI: String?, qualifiedName qName: String?, attributes attributeDict: [String : String] = [:]) {
        if elementName == "GetPurchaseListResult" {
            elementValue = String()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell=tableView12.dequeueReusableCell(withIdentifier: "cell") as! purchaseListShowTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc=st.instantiateViewController(withIdentifier: "purchaseWebView") as! UIViewController
        UIApplication.topViewController()?.present(vc, animated: true, completion: nil)
